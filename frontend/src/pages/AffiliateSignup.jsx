...
function AffiliateSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await API.post('/api/affiliate/auth/register', {
      ...
      if (!response?.data?.success) {
        throw new Error(response?.data?.error || response?.error || 'Signup failed');
      }
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 bg-gray-50 dark:bg-slate-900">
      <div className="max-w-md mx-auto p-8 border border-gray-200 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-800 shadow-lg">
        ...
        <button
          ...
          className="w-full mb-6 p-3 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-600 transition-all font-medium flex items-center justify-center gap-3"
        >
          <GoogleIcon />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-center text-sm text-gray-700 dark:text-gray-300">
            ...
            />
            Agree to{' '}
            <Link to="/terms" className="ml-1 text-indigo-600 dark:text-indigo-400 hover:underline">
        ...
        <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link to="/affiliate/login" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">
            Login
          </Link>
        </div>
      </div>
