...
function NewHeroSection() {
  return (
    <section className="relative pt-32 pb-20 px-4 overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white">
      {/* Background decorations */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-purple-300 rounded-full opacity-10 blur-3xl"></div>
        <div className="absolute top-60 -left-40 w-96 h-96 bg-indigo-300 rounded-full opacity-10 blur-3xl"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-indigo-100 rounded-full">
              ...
              <span className="text-sm font-medium text-indigo-900">AI-Powered Communication Platform</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#pricing"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-900 font-semibold rounded-xl border-2 border-gray-200 hover:border-indigo-600 hover:text-indigo-600 transition-all duration-200"
              >
                View Pricing
              </a>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-indigo-50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get your number in 60 seconds</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-indigo-50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">100+ countries available</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-indigo-50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Smart automation included</p>
                  </div>
                </div>
              </div>
            </div>
