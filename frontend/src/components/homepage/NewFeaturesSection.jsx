function NewFeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description: "Intelligently route calls based on time, location, and availability. Never miss an important call again."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Automatically record and transcribe all your calls. Perfect for training, quality assurance, and compliance."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Get real-time analytics and AI-driven recommendations to improve your customer communications."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
