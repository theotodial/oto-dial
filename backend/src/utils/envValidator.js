...
const optionalEnvVars = {
  ...
  TELNYX_MAX_MONTHLY_NUMBER_COST_NON_US: '500.0',
  TELNYX_MAX_MESSAGING_RATE_NON_US: '5.0',
  TELNYX_ENFORCE_NON_US_COST_CAPS: 'false',
  TELNYX_REGULATORY_CACHE_TTL_MS: '600000',
  READINESS_MONGO_WAIT_MS: '',
  MONGO_POST_INDEX_READY_MS: '',
