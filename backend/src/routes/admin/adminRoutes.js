...
import adminProfitability from "./adminProfitability.js";
import adminBillingReplay from "./adminBillingReplay.js";
import adminCreditReconciliation from "./adminCreditReconciliation.js";
import adminEconomicTimeline from "./adminEconomicTimeline.js";
import adminEconomicForensics from "./adminEconomicForensics.js";
import adminTelecomForensics from "./adminTelecomForensics.js";
import adminWebhookLatency from "./adminWebhookLatency.js";
import adminPerformanceHealth from "./adminPerformanceHealth.js";
import adminPressureForensics from "./adminPressureForensics.js";
import adminChaosForensics from "./adminChaosForensics.js";
import adminLiveBillingHealth from "./adminLiveBillingHealth.js";
...
import adminLiveActivity from "./adminLiveActivity.js";
import adminTelnyx from "./adminTelnyx.js";
import adminStripe from "./adminStripe.js";
...
router.use("/analytics/profitability", adminProfitability);
router.use("/analytics/billing", adminBillingReplay);
router.use("/analytics/billing", adminCreditReconciliation);
router.use("/analytics", adminEconomicTimeline);
router.use("/analytics/economic-forensics", adminEconomicForensics);
router.use("/analytics/telecom-forensics", adminTelecomForensics);
router.use("/analytics/webhook-latency", adminWebhookLatency);
router.use("/analytics", adminPerformanceHealth);
router.use("/analytics", adminPressureForensics);
router.use("/analytics", adminChaosForensics);
router.use("/analytics", adminLiveBillingHealth);
...
router.use("/live-activity", adminLiveActivity);
router.use("/telnyx", adminTelnyx);
router.use("/stripe", adminStripe);
